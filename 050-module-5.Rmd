...
4. [Maximum likelihood phylodynamics analysis](#phylodyn)
5. [Visualizing the phylogeny in auspice](#visualize-tree)
6. [Delphy Bayesian phylodynamic analysis](#delphy)
7. [End of lab](#end)
...
### 2. List of software for tutorial {#software}
...
:::: {type="orange" style="regular" title="Questions" collapsible="false" icon="true"}
...
:::: {type="green" style="regular" title="Answers" collapsible="true" icon="true"}
...
### 4. Maximum likelihood phylodynamic analysis {#phylodyn}
...
### 5. Visualizing the phylodynamic analysis {#visualize-tree}
...
:::: {type="orange" style="regular" title="You deserve a *little treat*" collapsible="true" icon="true"}
